...
<body
	...
	<hr />
	<div align="center">
		<form action="/dangdang_lcx/com.baizhi.action/BookAction/addBook" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>名称：</td>
					<td><input type="text" name="book.dname" class="el-input__inner"></td>
				...
				<tr>
					...
					<td>
						...
						<c:forEach var="e" items="${requestScope.lis }">
				...
				<tr>
					<td>开本：</td>
					<td><input type="text" name="book.dsize" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>纸张：</td>
