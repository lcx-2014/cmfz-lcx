...
<html>
	<head>
		...
		<link href="/dangdang_lcx/front/css/public_footer.css" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<table width="80%" border="0" align="center" cellspacing="0" cellpadding="5">
			<tr>
				<td rowspan="9" width="20%" valign="top"><img src="/dangdang_lcx/back/img/${book.cover }" width="240px" height="340px" /></td>
			...
			<tr>
				<td colspan="2">
					<a href="/dangdang_lcx/com.baizhi.action/CartAction/addCart?id=${book.id }">
		...
		<div class="public_footer">
			<div class="public_footer_bottom">
				<div class="public_footer_icp" style="line-height: 48px;">
					...
					<a href="#" target="_blank"><img src="/dangdang_lcx/front/images/bottom/validate.gif" border="0" align="middle" /> </a>
