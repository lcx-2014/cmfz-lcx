...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<c:forEach var="e" items="${sessionScope.car.car }">
					<tr>
						...
						<td valign="top">
							${e.value.book.dprice*e.value.count }
						</td>
					</tr>
					</c:forEach>
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						<b>总价￥${sessionScope.car.totalPrice }</b>
					</td>
				</tr>
			...
			<br />
			<div class="login_in">
				<a href="/dangdang_lcx/front/cart/cart_list.jsp">
					<input id="btnClientRegister" class="button_1" name="submit" type="submit" value="取消" />
				</a>		
				<a href="/dangdang_lcx/com.baizhi.action/AddressAction/panduanSign">
