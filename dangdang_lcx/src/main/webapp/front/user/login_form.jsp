			...
			<div class="enter_in">
				...
				<div class="center">
					...
					<div class="main">
						...
						<form method="post" action="/dangdang_lcx/com.baizhi.action/UserAction/login" id="ctl00">
							<span style="color:red;font-size: 21px;margin-left: 45px;">${requestScope.msage}</span>
							<ul>
								<li>
